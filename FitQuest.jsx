...
// ─── Colors ────────────────────────────────────────────────────────────────────
const COLORS = {
  appBg:    "#0a0612",       // deep purple-black
  panel:    "#140d1f",       // rich dark purple
  panelAlt: "#1a1129",       // slightly lighter
  border:   "#2e1d4a",       // purple border
  text:     "#f0e8ff",       // soft lavender white
  textMuted:"#9b7ec8",       // muted purple
  primary:  "#7c3aed",       // vivid violet
  primaryLight: "#a855f7",   // lighter violet
  accent:   "#f59e0b",       // golden amber
  success:  "#10b981",       // emerald green
  warning:  "#f59e0b",       // amber
  danger:   "#ef4444",       // red
  xp:       "#c084fc",       // soft purple xp
  streak:   "#f97316",       // orange streak
  gold:     "#fbbf24",       // gold for rewards
  neon:     "#06d6a0",       // neon green accent
};
    ...
    <View style={styles.onboardWrap}>
      ...
      <View style={styles.onboardCard}>
        ...
        <TextInput
          ...
          maxLength={20}
        />
        <Text style={styles.onboardHint}>No password needed. Just your name.</Text>
      </View>
      <Pressable
        onPress={goNext}
        disabled={!hasName}
        style={[styles.onboardBtn, !hasName && { opacity: 0.4 }]}
      >
...
function WorkoutTypeScreen({ workoutPlan, setWorkoutPlan, onBack, onContinue }) {
  ...
  return (
    <View style={styles.workoutSelectScreen} {...panResponder.panHandlers}>
      <Image source={require("./assets/workout-bg.png")} style={styles.workoutSelectBg} resizeMode="cover" />
      <View style={styles.workoutSelectOverlay} />
...
const styles = StyleSheet.create({
  ...
  // ─ Typography
  screenTitle: { fontSize: 26, fontWeight: "900", color: COLORS.text, marginBottom: 6, letterSpacing: -0.5 },
  ...
  // ─ Panels / Cards
  panel: { backgroundColor: COLORS.panel, borderColor: COLORS.border, borderWidth: 1, borderRadius: 18, padding: 16, marginBottom: 12 },
  ...
  // ─ Buttons
  primaryButton: { minHeight: 50, borderRadius: 14, backgroundColor: COLORS.primary, alignItems: "center", justifyContent: "center", paddingHorizontal: 16, marginBottom: 8 },
  primaryButtonText: { color: "#ffffff", fontWeight: "800", fontSize: 14, textAlign: "center" },
  buttonPressed: { opacity: 0.8 },
  buttonDisabled: { opacity: 0.4 },
  secondaryButton: { backgroundColor: COLORS.panel, borderWidth: 1, borderColor: COLORS.border },
  ...
  pillActive: { borderColor: COLORS.primaryLight, backgroundColor: "#2e1d4a" },
  ...
  // ─── ONBOARDING ──────────────────────────────────────────────────────────────
  onboardWrap: { flex: 1, backgroundColor: COLORS.appBg, paddingHorizontal: 20, paddingTop: 60, paddingBottom: 40, alignItems: "center", justifyContent: "center" },
  onboardGlow: { position: "absolute", top: -80, width: 320, height: 320, borderRadius: 160, alignSelf: "center" },
  onboardLogoWrap: { alignItems: "center", marginBottom: 28 },
  onboardLogoEmoji: { fontSize: 64, marginBottom: 10 },
  ...
  onboardPill: { borderWidth: 1, borderColor: COLORS.border, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 5, backgroundColor: COLORS.panel },
  onboardPillText: { color: COLORS.textMuted, fontSize: 11, fontWeight: "600" },
  onboardCard: { width: "100%", backgroundColor: COLORS.panel, borderWidth: 1, borderColor: COLORS.border, borderRadius: 20, padding: 20, marginBottom: 16 },
  ...
  onboardBtn: { width: "100%", minHeight: 56, borderRadius: 16, backgroundColor: COLORS.primary, alignItems: "center", justifyContent: "center", shadowColor: COLORS.primary, shadowOpacity: 0.55, shadowRadius: 16, shadowOffset: { width: 0, height: 6 }, elevation: 8 },
  ...
  goalBigCardActive: { borderColor: COLORS.primaryLight, backgroundColor: "#1f1235" },
  ...
  // ─── DASHBOARD ───────────────────────────────────────────────────────────────
  playerHUDCard: { backgroundColor: COLORS.panel, borderWidth: 1, borderColor: COLORS.border, borderRadius: 22, padding: 16, marginBottom: 14, shadowColor: COLORS.primary, shadowOpacity: 0.1, shadowRadius: 12 },
  ...
  levelBadge: { backgroundColor: "#2e1d4a", borderWidth: 1, borderColor: COLORS.primaryLight, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 2 },
  ...
  xpTrack: { height: 9, borderRadius: 999, backgroundColor: "#1a0e2e", overflow: "visible" },
  ...
  ringTrack: { width: "100%", marginTop: 6, height: 4, backgroundColor: "#1e1030", borderRadius: 999, overflow: "hidden" },
  ringFill: { height: "100%" },
  ...
  achChipUnlocked: { borderColor: "#5b21b6", backgroundColor: "#1a1030" },
  ...
  achWallCardUnlocked: { borderColor: "#5b21b6", backgroundColor: "#12102a", opacity: 1 },
  ...
  // ─ Streak badge
  streakBadge: { flexDirection: "row", alignItems: "center", backgroundColor: "#2d1200", borderWidth: 1, borderColor: "#7a3000", borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3, marginLeft: 6 },
  streakIcon: { fontSize: 12 },
  streakText: { color: COLORS.streak, fontWeight: "900", fontSize: 13, marginHorizontal: 3 },
  streakLabel: { color: "#c2541a", fontSize: 10, fontWeight: "600" },
  ...
  dayStatusPill: { alignSelf: "flex-start", borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3, backgroundColor: "#1e1530", color: COLORS.textMuted, fontSize: 10, fontWeight: "700", marginBottom: 6, overflow: "hidden" },
  dayStatusPillActive: { backgroundColor: "#2e1d4a", color: COLORS.primaryLight },
  dayStatusPillCompleted: { backgroundColor: "#0d2d1e", color: "#34d399" },
  dayStatusPillLocked: { backgroundColor: "#1a0e2e", color: "#5b4d7a" },
  ...
  dayTimelineCardTitleLocked: { color: "#5b4d7a" },
  ...
  workoutSelectOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(10,6,18,0.82)" },
  ...
  workoutTypeCardActive: { borderColor: COLORS.primaryLight, backgroundColor: "rgba(124,58,237,0.2)", shadowColor: COLORS.primary, shadowOpacity: 0.6, shadowRadius: 16, elevation: 8 },
  workoutTypeCardInactive: { borderColor: "#2e1d4a", backgroundColor: "rgba(20,13,31,0.8)" },
  ...
  choiceCardActive: { borderColor: COLORS.primaryLight, backgroundColor: "#1a1030" },
  ...
  // ─── SUMMARY ─────────────────────────────────────────────────────────────────
  summaryPointsCard: { backgroundColor: "#0e0820", borderWidth: 1.5, borderColor: COLORS.primaryLight, borderRadius: 18, padding: 18, marginBottom: 14, alignItems: "center", shadowColor: COLORS.primary, shadowOpacity: 0.3, shadowRadius: 16 },
  ...
  levelUpBanner: { backgroundColor: "#1a0c4a", borderWidth: 1, borderColor: COLORS.xp, borderRadius: 12, padding: 12, marginBottom: 12, alignItems: "center" },
  levelUpText: { color: COLORS.xp, fontWeight: "900", fontSize: 15 },
  progressLine: { color: COLORS.text, marginBottom: 6, fontSize: 13 },
  levelTrack: { height: 9, borderRadius: 999, backgroundColor: "#1a0e2e", overflow: "hidden", marginTop: 6 },
  ...
  summaryAchCard: { backgroundColor: "#12102a", borderWidth: 1, borderColor: "#5b21b6", borderRadius: 18, padding: 16, marginBottom: 10 },
  ...
  charXPBadge: { backgroundColor: "#2e1d4a", borderWidth: 1, borderColor: COLORS.primaryLight, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4 },
